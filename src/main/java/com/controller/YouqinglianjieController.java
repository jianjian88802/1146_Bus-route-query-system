...
public class YouqinglianjieController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		youqinglianjie.setClicknum(youqinglianjie.getClicknum()+1);
		youqinglianjie.setClicktime(new Date());
		youqinglianjieService.updateById(youqinglianjie);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,YouqinglianjieEntity youqinglianjie, HttpServletRequest request,String pre){
        EntityWrapper<YouqinglianjieEntity> ew = new EntityWrapper<YouqinglianjieEntity>();
